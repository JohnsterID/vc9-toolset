# vc9-cross-x64.cmake — CMake toolchain for cross-compiling to Win64 x64
#                        from Linux (or any host with clang + lld-link).
#
# Usage:
#   cmake -G Ninja -B build \
#     -DCMAKE_TOOLCHAIN_FILE=toolchain/vc9-cross-x64.cmake \
...
set(CMAKE_EXE_LINKER_FLAGS_INIT
    "-fuse-ld=lld-link -Xlinker /MACHINE:x64 -Xlinker /SUBSYSTEM:CONSOLE -Xlinker /ENTRY:mainCRTStartup -Xlinker /LIBPATH:${VC9_ROOT}/VC/lib/amd64 -Xlinker /LIBPATH:${VC9_ROOT}/WinSDK/Lib/x64")
